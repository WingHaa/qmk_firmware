...
KC_LEFT_SHIFT, K20,  K21,  K22,  K23,  K24,   K25,  K26,  K27,  K28,  K29,  KC_RIGHT_SHIFT , \
                     K32,  K33,  K34,         K35,  K36,  K37 \
)
#endif

// Swapped TAB and ESC on left thumbs
...
U_NP,              U_NP,              LT(U_MOUSE,KC_ESC),LT(U_MEDIA,KC_TAB),LT(U_NAV,KC_SPC),  LT(U_SYM,KC_ENT),  LT(U_NUM,KC_BSPC), LT(U_FUN,KC_DEL),  U_NP,              U_NP
